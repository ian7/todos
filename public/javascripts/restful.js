...
var userColumns =  [
    ...
    {header: "Notes", width: 50, sortable: true, dataIndex: 'notes', editor: new Ext.form.TextField({})},
    {header: "Priority", width: 50, sortable: true, dataIndex: 'priority', editor: new Ext.form.TextField({})}
];
